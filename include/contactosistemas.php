...
//	}
    ...
    protected function initiateEditor() {
                $tableColumns['id_sistemascontacto'] = array(
            'display_text' => 'Id',
            'req' => true,
                    'perms' => 'XQS'
        );
        $tableColumns['sistemas_inf_id_sistema'] = array(
            'display_text' => 'ID de Sistema de Información',
            'req' => true,
            'perms' => 'TVQSXO'
        );
        ...
        $tableColumns['sistemas_inf_id_sistema'] = array(
            ...
            'join' => array(
                'table' => 'sistemas_inf',
                'column' => 'id_sistema',
                'display_mask' => "concat(sistemas_inf.id_sistema,' ',sistemas_inf.nombre_sis)",
                'type' => 'left'
            )
        );
        $tableColumns['contacto_id_contacto'] = array(
        ...
        $tableColumns['sis_rol'] = array(
            'display_text' => 'Rol que desempeña en el Sistema de Información',
            'req' => true,
            'perms' => 'EVCTAXQSHO',
            'val_fun' => array(&$this,'vallet')
        );
        
        $tableColumns['sis_nombre_usuario'] = array(
        ...
        $tableColumns['sis_password'] = array(
...
$tableColumns['sis_fecha_alta'] = array( 
          'display_text' => 'Fecha Alta', 
          'perms' => 'EATVXSQ', 
          'display_mask' => 'date_format(`sis_fecha_alta`,"%d%M%Y")', 
          'order_mask' => 'date_format(`sis_fecha_alta`,"%Y%m%d %T")', 
          'range_mask' => 'date_format(`sis_fecha_alta`,"%Y%m%d %T")', 
          'calendar' => array( 
          'js_format' => 'yymmdd', 
        ...
        $tableName = 'sistemas_inf_has_contacto';
        $primaryCol = 'id_sistemascontacto';
        ...
        $this->Editor->setConfig('tableTitle', 'Contacto de Sistema');
        $this->Editor->setConfig('addRowTitle', 'Agregar Contacto a Sistema');
        $this->Editor->setConfig('editRowTitle', 'Editar Contacto a Sistema');
